...
class ProductPage(BasePage):
    ...
    def add_to_basket(self):
        add_to_cart_button = self.browser.find_element(*ProductPageLocator.ADD_TO_BASKET)
        add_to_cart_button.click()
        self.solve_quiz_and_get_code()

    def should_be_match_title(self):
        assert (self.browser.find_element(*ProductPageLocator.THE_PRODUCT_ADDED_TO_THE_BASKET).text ==
    ...
    def should_be_the_same_price(self):
        assert (self.browser.find_element(*ProductPageLocator.THE_COST_OF_THE_BASKET).text ==
                self.browser.find_element(*ProductPageLocator.TOTAL_IN_THE_BASKET).text), \
